/*
 ...
 User_Setup.h file in the TFT_ILI9163 library folder.
...
void setup(void) {
  Serial.begin(9600);
  Serial.print("Hello! ILI9163 TFT Test");

  // Use this initializer if you're using a 1.8" TFT
  tft.init();   // initialize a ILI9163S chip
  ...
  // large block of text
  tft.fillScreen(ILI9163_BLACK);
  testdrawtext("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur adipiscing ante sed nibh tincidunt feugiat. Maecenas enim massa, fringilla sed malesuada et, malesuada sit amet turpis. Sed porttitor neque ut ante pretium vitae malesuada nunc bibendum. Nullam aliquet ultrices massa eu hendrerit. Ut sed nisi lorem. In vestibulum purus a tortor imperdiet posuere. ", ILI9163_WHITE);
  delay(1000);
  ...
  // a single pixel
  tft.drawPixel(tft.width()/2, tft.height()/2, ILI9163_GREEN);
  delay(500);

  // line draw test
  testlines(ILI9163_YELLOW);
  delay(500);

  // optimized lines
  testfastlines(ILI9163_RED, ILI9163_BLUE);
  delay(500);

  testdrawrects(ILI9163_GREEN);
  delay(500);

  testfillrects(ILI9163_YELLOW, ILI9163_MAGENTA);
  delay(500);

  tft.fillScreen(ILI9163_BLACK);
  testfillcircles(10, ILI9163_BLUE);
  testdrawcircles(10, ILI9163_WHITE);
  delay(500);
...
void tftPrintTest() {
  ...
  tft.fillScreen(ILI9163_BLACK);
  tft.setCursor(0, 30);
  tft.setTextColor(ILI9163_RED);
  tft.setTextSize(1);
  tft.println("Hello World!");
  tft.setTextColor(ILI9163_YELLOW);
  tft.setTextSize(2);
  tft.println("Hello World!");
  tft.setTextColor(ILI9163_GREEN);
  tft.setTextSize(3);
  tft.println("Hello World!");
  ...
  tft.setTextColor(ILI9163_MAGENTA);
...
void mediabuttons() {
  // play
  tft.fillScreen(ILI9163_BLACK);
  tft.fillRoundRect(25, 10, 78, 60, 8, ILI9163_WHITE);
  tft.fillTriangle(42, 20, 42, 60, 90, 40, ILI9163_RED);
  delay(500);
  // pause
  tft.fillRoundRect(25, 90, 78, 60, 8, ILI9163_WHITE);
  tft.fillRoundRect(39, 98, 20, 45, 5, ILI9163_GREEN);
  tft.fillRoundRect(69, 98, 20, 45, 5, ILI9163_GREEN);
  delay(500);
  // play color
  tft.fillTriangle(42, 20, 42, 60, 90, 40, ILI9163_BLUE);
  delay(50);
  // pause color
  tft.fillRoundRect(39, 98, 20, 45, 5, ILI9163_RED);
  tft.fillRoundRect(69, 98, 20, 45, 5, ILI9163_RED);
  // play color
  tft.fillTriangle(42, 20, 42, 60, 90, 40, ILI9163_GREEN);
}
